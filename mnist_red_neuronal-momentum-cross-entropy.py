...
#usaron los datos de entrenamiento con 30 epocas, 15 mini batch, un learning rate de 3.0 
#y un momentum de 0.9, ademas se uso la funcion de costo de cross entropy
net.SGD_momentum( training_data, 30, 15, 3.0, 0.9, test_data=test_data)
...
#net.SGD_momentum( training_data, 10, 50, 0.5, test_data=test_data)
