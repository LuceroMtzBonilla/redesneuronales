...
class Network(object):
  #_init_ es el constructor  
    def __init__(self, sizes):
        ...
        #definiendo  las variables internas
    ...
    #Algoritmo del optimizador Stochastic Gradient Descent 
    ...
    #Algoritmo para actualizar los pesos de la red neuronal
    #Aprendizaje y optimizacion de la red 
   ...
   #Algoritmo del optimizador Stochastic Gradient Descent con momentum     
    ...
    # backward pass
    #al utilizar cross entropy cambiamos la funcion de costo y dado que los pesos
    #se actualizan de acuerdo a la derivada de la funcion de costo, estos valores 
    #cambian, por lo que el error delta es diferente y las nablas tambien
...
#usamos la funcion de costo de cross entropy
